                ...
                <ul class="navbar-mobile__list list-unstyled">
                    <li class="has-sub">
                        <a class="js-arrow" href="#">
                            <i class="fas fa-tachometer-alt"></i>public</a>
                        <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                            <li>
                                <a href="index.html">public 1</a>
                            </li>
                            <li>
                                <a href="index2.html">public 2</a>
                            </li>
                            <li>
                                <a href="index3.html">public 3</a>
                            </li>
                            <li>
                                <a href="index4.html">public 4</a>
                            </li>
                        </ul>
                    </li>
                    <li>
